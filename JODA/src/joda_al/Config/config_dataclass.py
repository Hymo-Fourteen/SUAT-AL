...
class ExperimentConfig:
    ...
    Parameters:
        ...
        method_type (str): Active learning method type. Default is "lloss".
        base (str): Cycle/run type (e.g. Pool, StreamBatch, Full). Default is "StreamBatch".
    """
